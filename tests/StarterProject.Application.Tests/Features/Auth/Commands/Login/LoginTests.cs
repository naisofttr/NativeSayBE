...
public class LoginTests
{
    ...
    {
        _loginCommand.UserForLoginDto = new() { Email = "alitas7875@gmail.com", Password = "123456" };
    ...
    {
        _loginCommand.UserForLoginDto = new() { Email = "alitas7875@gmail.com", Password = "123456789" };
    ...
    {
        _loginCommand.UserForLoginDto = new() { Email = "alitas7875@gmail.com", Password = "1" };
    ...
    {
        _loginCommand.UserForLoginDto = new() { Email = "alitas7875@gmail.com", Password = null! };
        TestValidationResult<LoginCommand> validationResult = _validator.TestValidate(_loginCommand);
        validationResult.ShouldHaveValidationErrorFor(i => i.UserForLoginDto.Password);
    }
}
