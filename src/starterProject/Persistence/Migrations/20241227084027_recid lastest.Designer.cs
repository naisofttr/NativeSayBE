...
namespace Persistence.Migrations
{
    ...
    [Migration("20241227084027_recid lastest")]
    partial class recidlastest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a72a1eb-f15a-437d-a98e-10895e2df1ce"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@tr",
                            PasswordHash = new byte[] { 238, 146, 134, 170, 248, 189, 192, 64, 172, 79, 255, 43, 18, 139, 236, 134, 66, 218, 71, 144, 113, 115, 185, 26, 100, 71, 165, 100, 84, 34, 189, 101, 11, 160, 240, 83, 27, 89, 190, 158, 35, 225, 93, 29, 19, 93, 189, 92, 204, 218, 89, 250, 164, 1, 46, 171, 142, 174, 202, 109, 62, 181, 16, 216 },
                            PasswordSalt = new byte[] { 79, 37, 240, 141, 238, 5, 64, 189, 235, 10, 203, 221, 7, 89, 167, 88, 169, 158, 186, 144, 165, 69, 56, 12, 181, 79, 50, 20, 158, 125, 29, 26, 49, 56, 21, 107, 79, 114, 235, 60, 3, 56, 159, 192, 201, 164, 157, 49, 114, 95, 45, 15, 145, 202, 97, 178, 126, 138, 99, 240, 168, 222, 178, 143, 100, 77, 207, 242, 95, 5, 12, 28, 198, 3, 188, 87, 193, 229, 163, 210, 14, 179, 240, 242, 99, 54, 156, 232, 124, 3, 244, 54, 101, 89, 165, 19, 142, 111, 211, 133, 31, 178, 181, 34, 90, 195, 131, 217, 248, 77, 215, 46, 218, 21, 64, 93, 141, 63, 246, 83, 213, 200, 253, 115, 220, 234, 194, 57 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d2c77c02-5de5-49f6-95cb-25f73df68c82"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("3a72a1eb-f15a-437d-a98e-10895e2df1ce")
                        });
                });
